<div id="wrapper">
	    ...
	    <div id="content">
	       ...
	       <div class="sliderbg ">
	       		 ...
	       		 <?php echo form_open('cart/deduct_credit/'.$encrypt .'/'.$customer_id, 'class="form-horizontal"'); ?>
	             <div class="pages_container">
	            	...
	            	<hr/>
					 ...
					 <div class="control-group">
		             	 <label class="control-label" for="credit_amount"><?php echo lang('credit_amount');?></label> <span style="color:red"> * </span>           	
		            	<div class="controls">
							<input type="text" name="credit_amount" id="credit_amount" value="<?php echo set_value('credit_amount') ?>" class="form_input radius4 required"/>							
						 </div>
					 </div>
