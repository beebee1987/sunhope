	...
	<div id="content">
		...
		<div class="sliderbg">
			<div class="pages_container">
				...
				<?php echo form_open('cart/process_coupon/'.$customer_id.'/'.$coupon_id, 'class="form-horizontal"'); ?>
	            	...
	            	<div class="control-group">
		            	...
		            	<div class="controls">
							<?php echo '<div class="col-sm-10">'.form_dropdown('coupon_id', $coupons, set_value('coupon_id',$coupon_id), 'id="coupon_id" class="form_input radius4 required"').'</div>';; ?>							
						 </div>
					</div>
