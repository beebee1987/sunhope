<div class="content">
		...
		<div class="page-header">
			...
			<span></span>
			<?php echo form_open('secure/login', 'id="login_form" name="login_form" class="form-horizontal"'); ?>				
				<fieldset>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="submit" value="<?php echo lang('form_login');?>" name="submit" id="submit" class="btn btn-primary btn-block"/>
						</div>
					</div>
				</fieldset>
