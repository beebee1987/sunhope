                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5><?php echo lang('deduct_credit')?></h5>
                            
                        </div>
                        <div class="ibox-content">
                                                
								<?php echo form_open($this->config->item('admin_folder').'/credit/deduct_credit_form/'.$id, 'class="form-horizontal"'); ?>
								  ...
								  <div class="form-group"><label class="col-sm-2 control-label"><?php echo lang('credit_amount');?></label>
									<?php
									$data	= array('name'=>'credit_amount', 'value'=>set_value('credit_amount', $out), 'class'=>'form-control', 'id'=> 'credit_amount');
									echo '<div class="col-sm-10">'.form_input($data).'</div>'; ?>
								  </div>								  
                              ...
                              <div class="hr-line-dashed"></div>                              															
								...
								<input type="hidden" value="Credit" name="payment"/>					
