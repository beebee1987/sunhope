                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
								...
								<?php echo form_open($this->config->item('admin_folder').'/point/branch_point_form/'.$id, 'class="form-horizontal"'); ?>
								  ...
								  <div class="form-group"><label class="col-sm-2 control-label"><?php echo lang('cost');?></label>
                                    <?php
										$data	= array('name'=>'cost', 'value'=>set_value('cost', $cost), 'class'=>'form-control');
										echo '<div class="col-sm-10">'.form_input($data).'</div>'; ?>
                                  </div>
								 
								  <div class="form-group"><label class="col-sm-2 control-label"><?php echo lang('point_amount');?></label>
                                    <?php
										$data	= array('name'=>'point_amount', 'value'=>set_value('point_amount', $point_amount), 'class'=>'form-control');
										echo '<div class="col-sm-10">'.form_input($data).'</div>'; ?>
                                  </div>
                                  <div class="hr-line-dashed"></div>
