...
CREATE TABLE `admin` (
  ...
  `branch_id` int(9) unsigned NOT NULL,
...
INSERT INTO `admin` VALUES (1,0,'Testing','Casey','admin','admin@test.com','Admin','acb6575ad96e591bac520af03be6bf03dfe675f3',1),(2,2,'Nai','Mei','nana','nana@red.com','Admin','fd8fca90ed05d83e24bda699b7169f69bbf23e5a',1),(3,1,'Tankk','KK','segnetwork','III@TMT.MY','Supervisor','fd8fca90ed05d83e24bda699b7169f69bbf23e5a',1),(4,3,'myleng','myleng','myleng','myleng@tmt.my','Merchant','7c4a8d09ca3762af61e59520943dc26494f8941b',1);
...
INSERT INTO `banner_collections` VALUES (1,'Homepage Banners 22'),(2,'Homepage Boxes 11'),(3,'1235');
...
INSERT INTO `banners` VALUES (1,1,'Penang','2015-05-05','2015-05-27','e3a61c003ea3faec764a219828649abf.png','Yes',0,0),(2,2,'时尚','2015-05-03','2015-05-26','235a77978d30a680ebe9ba53c20e8e43.jpg','http://www.google.com',1,1),(3,2,'潮流','2015-05-01','2015-05-31','710e854361eaf2e728176ac7cdf597bb.jpg','www.yahoo.com',1,0);
...
INSERT INTO `branch` VALUES (1,'Sasa','Test','haha',1),(2,'Dodo',NULL,NULL,1),(3,'empty',NULL,NULL,1);
/*!40000 ALTER TABLE `branch` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `branch_point`
--

DROP TABLE IF EXISTS `branch_point`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `branch_point` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `branch_id` int(9) unsigned DEFAULT '0',
  `trx_no` varchar(60) NOT NULL DEFAULT '',
  `cost` decimal(8,2) NOT NULL DEFAULT '0.00',
  `point` decimal(8,2) NOT NULL DEFAULT '0.00',
  `depoint` decimal(8,2) NOT NULL DEFAULT '0.00',
  `voucher_id` int(9) unsigned DEFAULT NULL,
  `customer_id` int(9) unsigned DEFAULT '0',
  `staff_id` int(9) unsigned DEFAULT '0',
...
--
-- Dumping data for table `branch_point`
--

LOCK TABLES `branch_point` WRITE;
/*!40000 ALTER TABLE `branch_point` DISABLE KEYS */;
INSERT INTO `branch_point` VALUES (1,1,'TRX80',5.00,66.00,0.00,NULL,0,1,'test','2015-06-23 23:04:17'),(2,2,'hehe',7.00,2.00,0.00,NULL,0,1,'1','2015-06-23 23:13:30'),(3,3,'4',5.00,6.00,0.00,NULL,0,1,'1','2015-06-23 23:17:38'),(4,2,'',0.00,0.00,0.00,NULL,3,2,'test','2015-06-23 23:30:04'),(5,2,'',0.00,0.00,1.00,NULL,3,2,'hehe','2015-06-23 23:38:23'),(6,2,'yyy',0.00,0.00,1.00,NULL,3,2,'111','2015-06-23 23:41:26'),(7,1,'ttt',0.00,0.00,1.00,NULL,1,1,'1','2015-06-23 23:48:59'),(8,1,'ggg',0.00,0.00,2.00,NULL,1,1,'test','2015-06-23 23:49:33');
/*!40000 ALTER TABLE `branch_point` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `company_details` VALUES (1,0,'companyA@aaa.com','Rest tian yian Cafe (Hers)','116','03-92818837','5625, 7, 9, Jln 3/93, Taman Miharja, Jalan Cheras','522','123<img src=\"data:image/png;base64,\" style=\"width: 1029px;\">','','0','','808754-H',1);
...
CREATE TABLE `coupons` (
  ...
  `point_consume` float(10,2) NOT NULL DEFAULT '0.00',
...
INSERT INTO `coupons` VALUES (1,'couponName','coupon1','2015-06-01','2015-06-30',0.00,0,1,0,0,'price','percent',1.00,'uploads/coupon/20150606/7535fbeaa9ee6994d74a649b6c1d71a7.jpg','123',1,2,2,'0000-00-00 00:00:00'),(2,'YOYO','yoyo','2015-06-01','2015-06-30',0.00,1,0,0,0,'price','0',0.00,'uploads/coupon/20150612/a700ea9936d0026b94f4ada3d6f51ba6.png','KEKE',1,3,1,'0000-00-00 00:00:00'),(3,'airen','airen','2015-06-01','2015-06-30',0.00,1,0,0,0,'price','0',0.00,'uploads/coupon/20150614/075096abe358940c51c08fa7e026a05d.png','123',1,1,2,'0000-00-00 00:00:00'),(4,'sasade','sasade','2015-06-01','2015-06-30',0.00,1,0,0,0,'price','0',0.00,'uploads/coupon/20150614/b51cd6393575412b7ed05065f85da11d.jpg','gao',1,3,1,'0000-00-00 00:00:00'),(5,'dodode','dodode','2015-06-01','2015-06-30',0.00,1,0,0,0,'price','0',0.00,'uploads/coupon/20150614/dbd1497ad8d0a333d387b5d242e434b2.jpg','12313123',1,2,2,'0000-00-00 00:00:00');
...
INSERT INTO `credit` VALUES (1,1,'',50.00,60.00,0.00,'2014-05-24 10:11:14',NULL,3,0,'yr',1),(2,1,'',60.00,80.00,0.00,'2015-05-24 10:20:32',NULL,3,0,'tets 2',1),(3,1,'',5.00,5.00,0.00,'2015-05-24 10:42:44',NULL,2,0,'cccccc',1),(4,2,'',90.00,800.00,0.00,'2015-05-24 11:08:52',NULL,2,0,'123',1),(5,2,'',50.00,60.00,0.00,'2015-05-25 04:38:10',NULL,2,0,'Test',1),(6,2,'',80.00,99.00,0.00,'2015-05-25 04:52:38',NULL,2,0,'ytest',1),(7,2,'',60.00,99.00,0.00,'2015-05-25 12:20:00',NULL,2,0,'Test Mozilla',1),(8,2,'',50.00,60.00,0.00,'2015-05-26 10:05:55',NULL,2,0,'TEsting',1),(9,2,'',8.00,10.00,0.00,'2015-05-29 08:48:34',NULL,2,0,'Testing by test',1),(10,2,'',5.00,10.00,0.00,'2015-05-29 08:58:11',NULL,2,0,'in0001',1),(11,2,'',9.00,10.00,0.00,'2015-05-29 09:10:21',NULL,2,0,'test',1),(12,2,'',8.00,10.00,0.00,'2015-05-29 09:12:27',NULL,2,0,'o',1),(13,2,'',8.00,9.00,0.00,'2015-05-29 09:39:16',NULL,2,0,'yyy',1),(14,1,'',50.00,60.00,0.00,'2015-06-01 00:00:00',NULL,3,0,'test',1),(15,2,'',4.00,5.00,0.00,'2015-06-02 00:00:00',NULL,1,0,'123',1),(16,1,'',0.00,0.00,55.00,'2015-06-03 00:00:00',NULL,1,0,'55',1),(17,2,'',5.00,8.00,0.00,'2015-06-01 00:00:00',NULL,1,0,'test',1),(18,2,'',5.00,6.00,0.00,'2015-06-01 00:00:00',NULL,1,0,'7',1),(19,2,'',5.00,6.00,0.00,'2015-06-01 00:00:00',NULL,1,0,'7',1),(20,2,'',0.00,0.00,1.00,'2015-06-01 00:00:00',NULL,1,0,'1',1),(21,1,'',0.00,0.00,66.00,'2015-06-17 00:00:00',NULL,1,0,'1',1),(22,1,'',0.00,0.00,2.00,'2015-06-17 00:00:00',NULL,1,0,'2',1),(23,2,'',0.00,0.00,5.00,'2015-06-12 00:00:00',NULL,1,0,'2',1),(24,3,'',60.00,100.00,0.00,'2015-06-07 23:06:35',NULL,2,0,'test',1),(25,3,'',0.00,0.00,5.00,'2015-06-07 23:23:20',1,2,0,'123',1),(26,3,'',0.00,0.00,5.00,'2015-06-07 23:37:29',1,2,0,'test',1),(27,3,'',1.00,2.00,0.00,'2015-06-08 00:12:02',NULL,2,0,'123',1),(28,3,'',0.00,0.00,5.00,'2015-06-01 00:00:00',1,1,0,'1',1),(29,3,'',0.00,0.00,5.00,'2015-06-01 00:00:00',1,1,0,'333',1),(30,3,'',0.00,0.00,5.00,'2015-06-09 09:54:34',1,2,0,'1',1),(31,3,'',0.00,0.00,5.00,'2015-06-11 23:43:47',1,2,0,'Testing',1),(32,3,'',0.00,0.00,7.00,'2015-06-11 23:49:57',2,2,0,'tes',1),(33,3,'',0.00,0.00,5.00,'2015-06-09 00:00:00',1,1,0,'test',1),(34,3,'',1.00,5.00,0.00,'2015-06-12 21:46:23',NULL,2,0,'1',1),(35,3,'',0.00,0.00,5.00,'2015-06-12 21:47:31',1,2,0,'123',1),(36,1,'',1.00,1.00,0.00,'2015-06-01 00:00:00',NULL,1,0,'1',1),(37,3,'',4.00,50.00,0.00,'2015-06-12 23:34:19',NULL,2,0,'123',1),(38,3,'',0.00,0.00,5.00,'2015-06-12 23:42:37',1,2,0,'123',1),(39,3,'',5.00,4.00,0.00,'2015-06-12 23:43:12',NULL,2,0,'88',1),(40,3,'',5.00,5.00,0.00,'2015-06-13 11:43:44',NULL,2,0,'1',1),(41,3,'',1.00,2.00,0.00,'2015-06-13 15:02:12',NULL,2,0,'3',1),(42,3,'',0.00,0.00,5.00,'2015-06-13 15:07:25',1,2,0,'1',1),(43,3,'',1.00,2.00,0.00,'2015-06-13 15:11:41',NULL,2,0,'3',1),(44,1,'',1.00,1.00,0.00,'2015-06-01 00:00:00',NULL,2,0,'1',1),(45,1,'',1.00,66.00,0.00,'2015-06-01 00:00:00',NULL,2,2,'hehe',1),(46,2,'',6.00,70.00,0.00,'2015-06-01 00:00:00',NULL,1,2,'hehe',1),(47,1,'',5.00,99.00,0.00,'2015-06-01 00:00:00',NULL,1,1,'tesy',1),(48,2,'',0.00,0.00,7.00,'2015-06-01 00:00:00',2,1,2,'3',1),(49,2,'',0.00,0.00,7.00,'2015-06-01 00:00:00',2,1,2,'45',1),(50,2,'',1.00,5.00,0.00,'2015-06-01 00:00:00',NULL,3,1,'123',1),(51,2,'',0.00,0.00,1.00,'2015-06-01 00:00:00',6,3,1,'5555',1),(52,3,'',5.00,10.00,0.00,'2015-06-14 15:19:54',NULL,2,2,'10',1),(53,3,'',6.00,60.00,0.00,'2015-06-14 15:20:41',NULL,3,1,'test',1),(54,3,'',0.00,0.00,30.00,'2015-06-14 15:54:46',3,2,2,'55555',1),(55,3,'',0.00,0.00,5.00,'2015-06-14 15:56:05',9,4,2,'4445',1),(56,3,'',0.00,0.00,3.00,'2015-06-14 15:56:50',10,3,1,'1234',1),(57,8,'',5.00,6.00,0.00,'2015-06-14 00:00:00',NULL,4,3,'hehe',1),(58,3,'Trx220',0.00,0.00,5.00,'2015-06-15 17:14:59',NULL,2,2,'Clean something',1),(59,1,'TA005',0.00,0.00,55.00,'2015-06-15 21:20:01',NULL,1,1,'For Simple Deduct something',1),(60,2,'cha',0.00,0.00,5.00,'2015-06-15 21:23:46',NULL,3,1,'Test',1),(61,3,'',5.00,10.00,0.00,'2015-06-16 10:14:41',NULL,2,2,'test',1),(62,3,'y',0.00,0.00,1.00,'2015-06-16 16:20:06',NULL,2,2,'1',1),(63,3,'',0.00,0.00,2.00,'2015-06-16 16:27:56',11,2,2,'1',1);
...
CREATE TABLE `customer_coupon` (
  `coupon_id` int(9) unsigned NOT NULL DEFAULT '0',
  `customer_id` int(9) unsigned NOT NULL DEFAULT '0',
  `active` tinyint(1) NOT NULL DEFAULT '1',
...
INSERT INTO `customer_coupon` VALUES (1,2,0,1,1),(1,3,0,2,2),(2,2,0,1,0),(2,3,0,1,1);
/*!40000 ALTER TABLE `customer_coupon` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `customer_coupon_log`
--

DROP TABLE IF EXISTS `customer_coupon_log`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `customer_coupon_log` (
  `id` int(9) unsigned NOT NULL AUTO_INCREMENT,
  `coupon_id` int(9) unsigned NOT NULL DEFAULT '0',
  `customer_id` int(9) unsigned NOT NULL DEFAULT '0',
  `qty` int(9) NOT NULL DEFAULT '0',
  `used` int(9) NOT NULL DEFAULT '0',
  `trx_date` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `staff_id` int(9) unsigned DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping data for table `customer_coupon_log`
--

LOCK TABLES `customer_coupon_log` WRITE;
/*!40000 ALTER TABLE `customer_coupon_log` DISABLE KEYS */;
INSERT INTO `customer_coupon_log` VALUES (1,1,2,0,1,'2015-06-12 12:07:12',0),(2,1,2,0,1,'2015-06-12 12:07:40',0),(3,1,3,0,2,'2015-06-12 12:10:41',0),(4,1,2,0,1,'2015-06-14 11:53:25',1),(5,2,3,0,1,'2015-06-14 15:59:59',2);
/*!40000 ALTER TABLE `customer_coupon_log` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `customer_voucher` (
  `voucher_id` int(9) unsigned NOT NULL DEFAULT '0',
  `customer_id` int(9) unsigned NOT NULL DEFAULT '0',
  `active` tinyint(1) NOT NULL DEFAULT '1',
  `qty` int(9) NOT NULL DEFAULT '1',
  `used` int(9) NOT NULL DEFAULT '0',
...
INSERT INTO `customer_voucher` VALUES (1,2,0,1,1),(1,3,0,17,11),(1,7,0,1,0),(2,2,0,3,0),(2,3,1,2,1),(2,7,0,1,0),(3,2,0,1,0),(3,3,1,1,0),(6,2,1,1,0),(9,3,1,1,0),(10,3,1,1,0),(11,3,1,3,0);
/*!40000 ALTER TABLE `customer_voucher` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `customer_voucher_log`
--

DROP TABLE IF EXISTS `customer_voucher_log`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `customer_voucher_log` (
  `id` int(9) unsigned NOT NULL AUTO_INCREMENT,
  `voucher_id` int(9) unsigned NOT NULL DEFAULT '0',
  `customer_id` int(9) unsigned NOT NULL DEFAULT '0',
  `qty` int(9) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `customer_voucher_log`
--

LOCK TABLES `customer_voucher_log` WRITE;
/*!40000 ALTER TABLE `customer_voucher_log` DISABLE KEYS */;
INSERT INTO `customer_voucher_log` VALUES (1,1,2,0,1,'2015-06-12 12:08:10',0),(2,1,2,0,1,'2015-06-12 12:08:34',0),(3,1,3,0,1,'2015-06-12 12:09:28',0),(4,2,3,0,1,'2015-06-14 15:58:40',1);
/*!40000 ALTER TABLE `customer_voucher_log` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `customers` VALUES (1,'KC Tan','-','-',1,'pika564@hotmail.com',1,'0127029138','-',0,0,'true','fd8fca90ed05d83e24bda699b7169f69bbf23e5a',1,1,0),(2,'KK','0','0',2,'siriusbee@gmail.com',1,'60127029138','0',0,0,'true','fd8fca90ed05d83e24bda699b7169f69bbf23e5a',1,1,0),(3,'KC','0','0',3,'kctan@tmt.my',0,'60115558888','0',0,0,'true','fd8fca90ed05d83e24bda699b7169f69bbf23e5a',1,1,0),(4,'Test','-','-',4,'paa@hotmail.com',1,'0177029138','-',0,0,'true','fd8fca90ed05d83e24bda699b7169f69bbf23e5a',1,1,0),(5,'TEST 3','-','-',5,'kkk@tmt.my',1,'0187029138','-',0,0,'true','fd8fca90ed05d83e24bda699b7169f69bbf23e5a',1,1,0),(6,'Test 666','-','-',6,'ppp@hotmail.com',1,'60197029138','-',0,0,'true','123456',1,1,0),(7,'baba','-','-',7,'ppp@tmt.my',1,'60137029138','-',0,0,'true','7c4a8d09ca3762af61e59520943dc26494f8941b',1,1,0),(8,'wang da wen','0','0',10008,'yeah@test.com',0,'1122333','0',0,0,'true','7c4a8d09ca3762af61e59520943dc26494f8941b',1,1,0),(9,'zhang liang ying','-','-',9,'ling@tmt.my',1,'889999','-',0,0,'true','7c4a8d09ca3762af61e59520943dc26494f8941b',1,1,0);
...
INSERT INTO `news` VALUES (2,'Test','','etsts',1,'1','1','0000-00-00','0000-00-00','uploads/slider/20150607/7ac3cf498ea8049c9a44979b9c6cc7de.jpg','Enable'),(3,'1','','123',1,'1','1','0000-00-00','0000-00-00','','Enable');
...
INSERT INTO `pages` VALUES (1,0,'New Page','New Page','new-page',53,'<p>This is a New Page</p>',0,'New Page','New Page','',0),(2,0,'New Page 2','New Page 2?','new-page-2',61,'<p>New Page 2</p>',0,'New Page 2?','New Page 2?','',0),(3,1,'Sub Menu','Sub Menu','sub-menu',62,'<p>Sub Menu</p>',0,'Sub Menu','Sub Menu','',0);
...
INSERT INTO `point` VALUES (1,2,'',0.00,1.00,'2015-05-25 21:45:40',NULL,2,0,'1'),(2,2,'',0.00,50.00,'2015-05-26 10:11:19',NULL,2,0,'cash use11'),(3,2,'',0.00,5.00,'2015-05-29 08:55:53',NULL,2,0,'Test'),(4,2,'',0.00,8.00,'2015-05-29 09:41:35',NULL,2,0,'tets'),(5,2,'',0.00,1.00,'2015-06-01 00:00:00',NULL,1,0,'1'),(6,1,'',0.00,55.00,'2015-06-03 00:00:00',NULL,1,0,'55'),(7,1,'',0.00,55.00,'2015-06-03 00:00:00',NULL,1,0,'55'),(8,1,'',0.00,55.00,'2015-06-03 00:00:00',NULL,1,0,'5'),(9,3,'',0.00,5.00,'2015-06-07 22:42:10',1,2,0,'testing'),(10,3,'',0.00,5.00,'2015-06-07 22:43:00',1,2,0,'testing'),(11,3,'',0.00,2.00,'2015-06-07 22:57:29',2,2,0,'test'),(12,3,'',0.00,5.00,'2015-06-07 22:59:18',1,2,0,'test again'),(13,3,'',0.00,5.00,'2015-06-07 23:20:58',1,2,0,'123'),(14,3,'',0.00,5.00,'2015-06-07 23:22:14',1,2,0,'123'),(15,3,'',50.00,0.00,'0000-00-00 00:00:00',NULL,0,0,''),(16,3,'',0.00,10.00,'2015-06-07 23:29:13',1,2,0,'test'),(17,3,'',5.00,0.00,'2015-06-11 23:43:47',1,2,0,'Bonus Point from consumption'),(18,3,'',7.00,0.00,'2015-06-11 23:49:57',2,2,0,'Bonus Point from consumption'),(19,3,'',5.00,0.00,'2015-06-09 00:00:00',1,1,0,'Bonus Point from consumption'),(20,3,'',5.00,0.00,'2015-06-12 21:47:31',1,2,0,'Bonus Point from consumption'),(21,3,'',5.00,0.00,'2015-06-12 23:42:37',1,2,0,'Bonus Point from consumption'),(22,3,'',5.00,0.00,'2015-06-13 15:07:25',1,2,0,'Bonus Point from consumption'),(23,2,'',7.00,0.00,'2015-06-01 00:00:00',2,1,2,'Bonus Point from consumption'),(24,2,'',7.00,0.00,'2015-06-01 00:00:00',2,1,2,'Bonus Point from consumption'),(25,2,'',1.00,0.00,'2015-06-01 00:00:00',6,3,1,'Bonus Point from consumption'),(26,3,'',30.00,0.00,'2015-06-14 15:54:46',3,2,2,'Bonus Point from consumption'),(27,3,'',5.00,0.00,'2015-06-14 15:56:05',9,4,2,'Bonus Point from consumption'),(28,3,'',3.00,0.00,'2015-06-14 15:56:50',10,3,1,'Bonus Point from consumption'),(29,3,'Trx220',5.00,0.00,'2015-06-15 17:14:59',NULL,2,2,'Bonus Point from consumption'),(30,1,'TA005',55.00,0.00,'2015-06-15 21:20:01',NULL,1,1,'Bonus Point from consumption'),(31,2,'cha',5.00,0.00,'2015-06-15 21:23:46',NULL,3,1,'Bonus Point from consumption'),(32,3,'',52.00,0.00,'2015-06-15 21:40:50',NULL,3,0,'Test'),(33,4,'',1.00,0.00,'2015-06-15 21:51:21',NULL,1,2,'2'),(34,4,'',5.00,0.00,'2015-06-15 21:53:24',NULL,2,2,'4445'),(35,3,'558',2.00,0.00,'2015-06-16 00:44:17',NULL,1,1,'1'),(36,3,'trx',0.00,1.00,'2015-06-16 00:59:22',NULL,1,3,'1'),(37,3,'ttt',0.00,50.00,'2015-06-16 01:02:12',NULL,3,1,'wow'),(38,3,'',123.00,0.00,'2015-06-16 16:13:25',NULL,2,2,'hehe'),(39,3,'',0.00,5.00,'2015-06-16 16:19:39',NULL,2,2,'p000'),(40,3,'y',1.00,0.00,'2015-06-16 16:20:06',NULL,2,2,'Bonus Point from consumption'),(41,3,'',2.00,0.00,'2015-06-16 16:27:56',11,2,2,'Bonus Point from consumption'),(42,3,'',0.00,1.00,'2015-06-15 00:00:00',11,1,0,'1'),(43,3,'',0.00,1.00,'2015-06-01 00:00:00',11,1,2,'1'),(44,3,'',999999.99,0.00,'2015-06-23 23:30:04',NULL,2,2,'test'),(45,3,'',1.00,0.00,'2015-06-23 23:38:23',NULL,2,2,'hehe'),(46,3,'yyy',1.00,0.00,'2015-06-23 23:41:26',NULL,2,2,'111'),(47,1,'ttt',1.00,0.00,'2015-06-23 23:48:42',NULL,1,1,'1'),(48,1,'ttt',1.00,0.00,'2015-06-23 23:48:59',NULL,1,1,'1'),(49,1,'ggg',2.00,0.00,'2015-06-23 23:49:33',NULL,1,1,'test');
...
INSERT INTO `routes` VALUES (1,'new-form','cart/newform'),(2,'about','cart/about'),(3,'contact_us','cart/contact_us'),(4,'company_details','cart/company_details'),(5,'my_card','cart/my_card'),(6,'member_center','cart/member_center'),(7,'top_up_credit_qrcode','cart/top_up_credit_qrcode'),(8,'top_up_credit','cart/top_up_credit'),(9,'consumption','cart/consumption'),(10,'consumption_qrcode','cart/consumption_qrcode'),(11,'membership_promotion','cart/membership_promotion'),(12,'news','cart/news'),(13,'my_coupons','cart/my_coupons'),(14,'my_vouchers','cart/my_vouchers'),(15,'transaction_record','cart/transaction_record'),(16,'details','cart/details'),(17,'homeslide','cart/homeslide'),(18,'deduct_credit_qrcode','cart/deduct_credit_qrcode'),(19,'top_up_point_qrcode','cart/top_up_point_qrcode'),(20,'deduct_point_qrcode','cart/deduct_point_qrcode');
...
INSERT INTO `search` VALUES ('02264bb76808cb1006595b6a579ca1a3','{\"start_top\":\"01-06-2015\",\"end_top\":\"30-06-2015\"}'),('48fb23cf9d6f203c95a4b8e43933657c','{\"start_top\":\"29-05-2015\",\"end_top\":\"29-05-2015\",\"submit\":\"search\"}'),('49614adc9a10ec737c72e57cd6b4e554','{\"start_top\":\"15-06-2015\",\"end_top\":\"15-06-2015\"}'),('66a648d2b15a080526c0a25c37483fea','{\"start_top\":\"01-05-2015\",\"start_date\":\"\",\"end_top\":\"30-06-2015\",\"end_date\":\"\",\"submit\":\"search\"}'),('69820717fb82ccef088470fa3d65021c','{\"start_top\":\"14-06-2015\",\"end_top\":\"17-06-2015\"}'),('71d42330a1d4a3126959fd067b207b27','{\"start_top\":\"03-06-2015\",\"end_top\":\"03-06-2015\",\"submit\":\"search\"}'),('75f4a3f22eccfbe2673eb9d04d41107d','{\"start_top\":\"29-05-2015\",\"end_top\":\"31-05-2015\",\"submit\":\"search\"}'),('8ce4a70ea798a7d903a9fde43867b29c','{\"start_top\":\"\",\"end_top\":\"\"}'),('978d642c7c6caab997bbe58022981da4','{\"start_top\":\"\",\"end_top\":\"\",\"submit\":\"search\"}'),('ab0fe71817be45c991b233e9ea5821f1','{\"start_date\":\"\",\"end_date\":\"\",\"submit\":\"search\"}'),('d41d8cd98f00b204e9800998ecf8427e','');
...
INSERT INTO `settings` VALUES (1,'gocart','theme','unify'),(2,'gocart','ssl_support','0'),(3,'gocart','company_name','Red Merchant'),(4,'gocart','address1',''),(5,'gocart','address2',''),(6,'gocart','country',''),(7,'gocart','country_id',''),(8,'gocart','city',''),(9,'gocart','zone_id',''),(10,'gocart','state',''),(11,'gocart','zip',''),(12,'gocart','email',''),(13,'gocart','locale','fr_FR'),(14,'gocart','currency_iso','MYR'),(15,'gocart','weight_unit','LB'),(16,'gocart','dimension_unit','IN'),(17,'gocart','require_shipping','1'),(18,'gocart','site_logo','/images/logo.png'),(19,'gocart','admin_folder','admin'),(20,'gocart','new_customer_status','1'),(21,'gocart','require_login','0'),(22,'gocart','order_status','Order Placed'),(23,'gocart','order_statuses','{\"Order Placed\":\"Order Placed\",\"Pending\":\"Pending\",\"Processing\":\"Processing\",\"Shipped\":\"Shipped\",\"On Hold\":\"On Hold\",\"Cancelled\":\"Cancelled\",\"Delivered\":\"Delivered\"}'),(24,'gocart','inventory_enabled','0'),(25,'gocart','allow_os_purchase','1'),(26,'gocart','tax_address','ship'),(27,'gocart','tax_shipping','0'),(28,'gift_cards','predefined_card_amounts','10,20,25,50,100'),(29,'gift_cards','allow_custom_amount','1'),(30,'gift_cards','enabled','1'),(31,'gocart','image_card','uploads/card/20150607/DSC_1677.JPG');
...
INSERT INTO `slider` VALUES (1,'Test 1','','0',1,'1','1','0000-00-00','0000-00-00','uploads/slider/20150607/85e905427948c272e3b5421da21838de.jpg','Enable'),(2,'Test 2','','0',2,'2','2','0000-00-00','0000-00-00','uploads/slider/20150607/70457f90bc348a095e7aa5dd3235c3b7.jpg','Enable'),(3,'Test 3','','0',3,'3','3','0000-00-00','0000-00-00','57ae7a089c82ab795c31b9d999e0c57f.jpg','Enable');
...
CREATE TABLE `voucher_backup` (
  ...
  `point_consume` int(6) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `voucher_backup`
--

LOCK TABLES `voucher_backup` WRITE;
/*!40000 ALTER TABLE `voucher_backup` DISABLE KEYS */;
/*!40000 ALTER TABLE `voucher_backup` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `vouchers` (
  ...
  `end_date` date NOT NULL,
  `point_consume` float(10,2) NOT NULL DEFAULT '0.00',
  `credit_consume` float(10,2) NOT NULL DEFAULT '0.00',
  `whole_order_voucher` tinyint(1) NOT NULL,
  `max_product_instances` mediumint(8) unsigned NOT NULL DEFAULT '0',
  `max_uses` mediumint(8) unsigned NOT NULL DEFAULT '0',
  `num_uses` mediumint(8) unsigned NOT NULL,
  `reduction_target` varchar(8) NOT NULL,
...
INSERT INTO `vouchers` VALUES (1,'testcode1','Testing','2015-06-01','2015-06-30',10.00,5.00,1,1,1,0,'price','percent',1.00,'uploads/voucher/20150606/e2f1a39c634da651931fcbf39a4fb04c.jpg','456',1,2,2,'0000-00-00 00:00:00'),(2,'before','Voucher Name','2015-06-01','2015-06-30',2.00,7.00,1,1,1,0,'price','percent',1.00,'uploads/voucher/20150607/3cf2cc390ee92fda2cdf13a89ca154c2.jpg','123',1,2,2,'0000-00-00 00:00:00'),(3,'haha','HAHA','2015-06-01','2015-06-30',50.00,30.00,1,0,0,0,'price','0',0.00,'uploads/voucher/20150612/9976bddadd5de84f42b912c65ad9767a.jpg','yeyeyeyye',1,1,1,'0000-00-00 00:00:00'),(4,'burongyi','rongyi','2015-06-01','2015-06-30',1.00,1.00,1,0,0,0,'price','0',0.00,'uploads/voucher/20150613/f56d1d017c677e47848501721a681edd.PNG','23',1,0,0,'0000-00-00 00:00:00'),(5,'rongyi2','rongyi222','2015-06-01','2015-06-30',1.00,1.00,1,0,0,0,'price','0',0.00,'uploads/voucher/20150613/d3b503aab9fbeb9fe9c68c1c81e8a305.png','haha',1,NULL,0,'0000-00-00 00:00:00'),(6,'rongyi33','rongyi33','2015-06-01','2015-06-30',1.00,1.00,1,0,0,0,'price','0',0.00,'uploads/voucher/20150613/7e0bbfc25442f296d0794ce55ef5163a.jpg','Test',1,3,1,'0000-00-00 00:00:00'),(7,'BranchVoucher','123123','2015-06-01','2015-06-30',1.00,1.00,1,0,0,0,'price','0',0.00,'uploads/voucher/20150614/caa0df6381dc8de0cf0480191a9043f4.jpg','123132',1,1,0,'0000-00-00 00:00:00'),(8,'brach','cranchhh','2015-06-01','2015-06-30',1.00,2.00,1,0,0,0,'price','0',0.00,'uploads/voucher/20150614/475368003f57ea7723f41ce10606732c.PNG','ll',1,1,2,'0000-00-00 00:00:00'),(9,'gggg','gggg','2015-06-01','2015-06-30',1.00,5.00,1,0,0,0,'price','0',0.00,'uploads/voucher/20150614/9eb281ae37d03d1e5b828f76f4859648.jpg','55',1,2,2,'0000-00-00 00:00:00'),(10,'zha','zhha','2015-06-01','2015-06-30',2.00,3.00,1,0,0,0,'price','0',0.00,'uploads/voucher/20150614/c35a1c6b60d35d5aacb3deb09b0cd14b.jpg','s',1,3,1,'0000-00-00 00:00:00'),(11,'dodate','dodate','2015-05-31','2015-07-01',1.00,2.00,1,0,0,0,'price','0',0.00,'uploads/voucher/20150614/8b9f664e49832010f4b34fd0e3feda00.PNG','qwe',1,2,2,'2015-06-14 11:43:46'),(12,'tvoucher','ThiVou','2015-06-01','2015-06-30',1.00,5.00,1,0,0,0,'price','0',0.00,'uploads/voucher/20150614/9277c70448caf4e7b99fc3912c1f5ebb.jpg','test',1,4,3,'2015-06-14 16:50:09');
/*!40000 ALTER TABLE `vouchers` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `vouchers_products`
--

DROP TABLE IF EXISTS `vouchers_products`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `vouchers_products` (
  `voucher_id` int(9) unsigned NOT NULL,
  `product_id` int(9) unsigned NOT NULL,
  `sequence` int(9) unsigned NOT NULL,
...
--
-- Dumping data for table `vouchers_products`
--

LOCK TABLES `vouchers_products` WRITE;
/*!40000 ALTER TABLE `vouchers_products` DISABLE KEYS */;
/*!40000 ALTER TABLE `vouchers_products` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-08-15 17:04:27
